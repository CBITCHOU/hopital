         ...
         <div class="row">
            <div class="service-time middle" style="background:#0071d1;">
               ...
               <div class="time-table-section">
                  <ul>
                     <li><span class="left">lundi - vendredi</span><span class="right">8.00 – 18.00</span></li>
      ...
      <div class="row">
         <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="service-widget">
               ...
               <h3>Contrôle digital du centre</h3>
            </div>
            <!-- end service -->
         </div>
         <div class="col-md-3 col-sm-6 col-xs-12">
             ...
             <div class="inner-services">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                   <div class="serv">
                      ...
                      <h4>Banque de sang permanent</h4>
                      <p>Lorem Ipsum is simply dummy text of the printing.</p>
                   </div>
                </div>
             </div>
      ...
      <div class="row dev-list text-center">
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.2s; animation-name: fadeIn;">
              <div class="widget clearfix">
                  ...
                  <div class="widget-title">
                      ...
                      <small>responsable clinic</small>
                  </div>
                  <!-- end title -->
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.4s; animation-name: fadeIn;">
              <div class="widget clearfix">
                  ...
                  <div class="widget-title">
                      <h3>Bryan Saftler</h3>
                      <small>Maladies internationales</small>
                  </div>
                  <!-- end title -->
                  <p>Hello guys, I am Soren from Sirbistana. I am senior art director and founder of Violetta.</p>
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn">
              <div class="widget clearfix">
                  ...
                  <div class="widget-title">
                      ...
                      <small>Expert orthopédique</small>
                  </div>
                  <!-- end title -->
                  <p>Hello guys, I am Soren from Sirbistana. I am senior art director and founder of Violetta.</p>
                     ...
                     <div class="col-md-4">
                        <div class="pricing-table">
                           ...
                           <div class="pricing-table-features">
                              <p><i class="fa fa-envelope-o"></i> <strong>250</strong> Adresse Email</p>
                              <p><i class="fa fa-rocket"></i> <strong>125GB</strong> de stockage</p>
                              <p><i class="fa fa-database"></i> <strong>140</strong> bases de données</p>
                              <p><i class="fa fa-link"></i> <strong>60</strong> Noms de domaines</p>
                              <p><i class="fa fa-life-ring"></i> <strong>24/7 illimité</strong> Support</p>
                           </div>
                           <div class="pricing-table-sign-up">
                              <a href="#contact" data-scroll="" class="btn btn-dark btn-radius btn-brd">Commander maintenant</a>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4">
