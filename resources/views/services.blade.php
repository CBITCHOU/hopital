       ...
       <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
             <div class="appointment-form">
                <h3><span>+</span> Livre des requêtes</h3>
                <div class="form">
      ...
      <div class="row">
         <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="service-widget">
               ...
               <h3>Centre de contrôle digital</h3>
            </div>
            <!-- end service -->
         </div>
         <div class="col-md-3 col-sm-6 col-xs-12">
