                ...
                <ul class="mt-5 list-unstyled components text-secondary">
                    ...
                    <li>
                        <a href="#authmenu" data-toggle="collapse" aria-expanded="false"
                            class="dropdown-toggle no-caret-down"><i class="fas fa-user-shield"></i> Authentification</a>
                        <ul class="collapse list-unstyled" id="authmenu">
                            <li>
                                <a href="login.html"><i class="fas fa-lock"></i> Se connecter </a>
                            </li>

                            <li>
                                <a href="forgot-password.html"><i class="fas fa-user-lock"></i> Mot de passe oublié</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="{{ route('admin_settings') }}"><i class="fas fa-cog"></i>Règlages</a>
                    </li>
            </ul>
        </nav>
