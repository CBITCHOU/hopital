                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="Blood" wire:model.lazy="bloodgroup" class="form-control"  >
                         ...
                         <option value="AB+" class="text-red">AB+</option>
                         <option value="o+" class="text-red">o+</option>
                         <option value="o-" class="text-red">o-</option>
                        </select>
                        @error('Gender') <span class="text-red-500 text-danger text-xs">{{ $message }}</span> @enderror
                    </div>
                        ...
                        <tbody>
                            @forelse ($patients as $patient)
                                <tr>
                                    ...
                                    <!-- <td><img width="100%" height="70px" src="images/doctor_03.jpg" alt="Image"/></td> -->
                                    <td><img width="100%" height="70px" src="{{(env('APP_URL').'images/'. $patient->photo_path)  ? : config('app.url').'images/patient.png'  }}" alt="Image"/></td>
