            ...
            <div class="box box-primary" >
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="patient">Choisir Patient</label>
                    ...
                    <div class="form-group">
                        <label for="Nurse">choisir Infirmiers</label>
                    ...
                    <div class="form-group">
                        <label for="Doctor">choisir docteur</label>
                    ...
                    <div class="form-group">
                        <label for="end_time">Début du rendez-vous</label>
                    ...
                    <div class="form-group">
                        <label for="end_time">Fin du rendez-vous</label>
